...
const Anecdote = ({ anecdote }) => {
  ...
  const anecdotes = anecdote.find(a => a.id === Number(id))
  return (
    <div>
      <h2>{anecdotes.content} {anecdotes.author}</h2>
      <p>has {anecdotes.votes} votes</p>
      <p>for more info see {anecdotes.info}</p>
    </div>
  )
}
...
const CreateNew = ({ addNew, content, author, info}) => {
